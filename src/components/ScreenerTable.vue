...
const tableColumnList = ref<Record<string, TableColumn[]>>(
  {
    ...
    risk: [
      ...
      { prop: "beta1", label: "近1月Beta", width: 120, showTooltip: false, sortable: true },
      { prop: "beta3", label: "近3月Beta", width: 125, showTooltip: false, sortable: true },
      { prop: "beta12", label: "近1年Beta", width: 120, showTooltip: false, sortable: true },
      { prop: "beta36", label: "近3年Beta", width: 125, showTooltip: false, sortable: true },
    ...
    valuation: [
      ...
      { prop: "etfNp", label: "份额盈利", width: 120, showTooltip: false },
      { prop: "etfBe", label: "份额净资产", width: 120, showTooltip: false },
      { prop: "etfYs", label: "份额销售收入", width: 130, showTooltip: false },
      { prop: "etfCf", label: "份额现金流", width: 120, showTooltip: false },
      { prop: "etfD", label: "份额分红", width: 120, showTooltip: false },
